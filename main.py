...
def filtering():
    ...
    if choice == 1:
        ...
        output_format = int(input("1. Print the amount 2. Print the sum. 3. Print max. 4. Print min \n"))
        if output_format == 1:
            print(len(filtered))
...
type_choice = int(input("1. With the input of a number of numbers. 2. Lasting with 0. "))
if type_choice == 1:
    tocount()
elif type_choice == 2:
    tozero()
